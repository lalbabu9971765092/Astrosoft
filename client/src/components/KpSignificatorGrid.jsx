...
export const EVENT_HOUSES = { // Or pass this mapping as a prop
    ...
    'divorce': { favorable: [1, 6, 10], unfavorable: [2, 7, 11], significatorPlanet: 'Saturn, Rahu, Ketu' },
    'Plutonic-love': { favorable: [5, 11], unfavorable: [], significatorPlanet: '' },
    'Scandalous love affair': { favorable: [5, 8, 12], unfavorable: [], significatorPlanet: '' },
    'Rape': { favorable: [5, 8, 12], unfavorable: [], significatorPlanet: 'Rahu/Ketu and Venus' },
    'Prostitution': { favorable: [5, 8, 12], unfavorable: [], significatorPlanet: 'Appears in most planets' },
    'Call-girl': { favorable: [3, 5, 8, 12, 7, 11], unfavorable: [], significatorPlanet: 'Appears in most planets' },

    'litigation': { favorable: [6, 10, 11], unfavorable: [], significatorPlanet: 'Saturn, Rahu, Ketu' },
    'Imprisonment': { favorable: [2, 3, 8, 12], unfavorable: [], significatorPlanet: 'Rahu, Ketu' },
    'Bail/Win litigation': { favorable: [6, 10, 11], unfavorable: [], significatorPlanet: '' },
    'Political-confinement': { favorable: [2, 3, 12], unfavorable: [], significatorPlanet: '' },
    'House-arrest': { favorable: [4, 8, 12], unfavorable: [], significatorPlanet: 'Rahu/Ketu' },
    'Underground': { favorable: [3, 4, 8, 12], unfavorable: [], significatorPlanet: 'Rahu/Ketu' },
    'Kidnapping': { favorable: [2, 3, 4, 8, 12], unfavorable: [], significatorPlanet: 'Rahu/Ketu' },

    'Property_purchase': { favorable: [4, 11, 12], unfavorable: [], significatorPlanet: 'Mars/Saturn' },
    'property_sale': { favorable: [3, 5, 10], unfavorable: [], significatorPlanet: 'Mars/Saturn' },
    'Prperty purchase on loan': { favorable: [4, 6, 11, 12], unfavorable: [], significatorPlanet: 'Mars/Saturn' },
    'Change of residence': { favorable: [3, 5], unfavorable: [], significatorPlanet: 'Saturn, Rahu, Ketu' },
    ...
    'Theft_of_vehicle': { favorable: [4, 6, 8, 12], unfavorable: [], significatorPlanet: 'Venus Rahu/Ketu' },
    'Snatching of vehicle': { favorable: [4, 6, 8, 12], unfavorable: [], significatorPlanet: 'Venus Rahu/Ketu' },

    'Travel': { favorable: [3, 9, 12], unfavorable: [], significatorPlanet: 'Saturn, Rahu, Ketu' },
    'Coming back home': { favorable: [4, 11, 12], unfavorable: [], significatorPlanet: '' },
    ...
    'Change of Job/Business': { favorable: [5, 9], unfavorable: [], significatorPlanet: 'Saturn, Rahu, Ketu' },
    'Addition in business/job': { favorable: [5,9], unfavorable: [], significatorPlanet: 'Jupiter/Mercury' },


    'education': { favorable: [4, 5, 9, 11], unfavorable: [8, 12], significatorPlanet: 'Mercury' },
    'Maximum marks': { favorable: [4, 9, 11], unfavorable: [], significatorPlanet: '' },
    'Average marks': { favorable: [4, 5, 11], unfavorable: [], significatorPlanet: '' },
    'Fail': { favorable: [6, 8, 12], unfavorable: [], significatorPlanet: '' },
    'Success in competition': { favorable: [4, 5, 6, 9, 11], unfavorable: [], significatorPlanet: '' },
    'Getting an Award': { favorable: [10, 11], unfavorable: [], significatorPlanet: 'Jupiter/ Venus' },
    'Getting Prize': { favorable: [6, 11], unfavorable: [], significatorPlanet: 'Jupiter/ Venus' },
    'Illiterate': { favorable: [6, 8, 12], unfavorable: [], significatorPlanet: 'Malefic in fourth' },

    'Good health': { favorable: [1, 5, 9, 11], unfavorable: [], significatorPlanet: 'Jupiter' },
    'Incurable disease': { favorable: [1, 6, 8, 12], unfavorable: [], significatorPlanet: 'Saturn' },
    'Curable disease': { favorable: [1, 6, 12], unfavorable: [], significatorPlanet: '' },
    'Surgery': { favorable: [1, 6, 8], unfavorable: [], significatorPlanet: 'Mars/Ketu' },
    'Accident': { favorable: [1, 4, 8, 12], unfavorable: [], significatorPlanet: 'Rahu/Ketu' },
    ...
    'cold nature': { favorable: [1, 4, 6, 10], unfavorable: [], significatorPlanet: 'Saturn' },
    ...
    'No childbirth': { favorable: [1, 4, 10], unfavorable: [], significatorPlanet: '' },
    'Abortion': { favorable: [1, 4, 6, 10, 8, 12], unfavorable: [], significatorPlanet: 'Mars/Rahu/Ketu/Saturn' },
    'Custody of child to mother': { favorable: [4, 8], unfavorable: [], significatorPlanet: '' },
    'Custody of child to father': { favorable: [3, 9], unfavorable: [], significatorPlanet: '' },
    'Custody of child to third person': { favorable: [3, 8], unfavorable: [], significatorPlanet: '' },
    'Adoption': { favorable: [4, 8], unfavorable: [], significatorPlanet: 'Duality of Eighth House' },
