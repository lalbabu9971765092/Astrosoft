...
export async function calculateMoolDosha(dateString, latitude, longitude, siderealPositions, sunrise, nextSunrise) {
    ...
    const { julianDayUT: sunriseJD, momentLocal: momentLocalSunrise } = getJulianDateUT(sunrise.toISOString(), latitude, longitude);
    ...
    const { julianDayUT: nextSunriseJD, momentLocal: momentLocalNextSunrise } = getJulianDateUT(nextSunrise.toISOString(), latitude, longitude);
