...
const PlanetDetailsPage = () => {
    ...
    useEffect(() => {
        ...
        console.log(`PlanetDetailsPage: Triggering fetch for adjusted birth time: ${formattedDateForApi}`);
        ...
        const fetchRectifiedData = async () => {
            try {
                ...
                console.log("PlanetDetailsPage: Rectified data received:", response.data);
            } catch (err) {
