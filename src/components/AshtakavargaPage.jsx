...
const AshtakavargaPage = () => {
    ...
    useEffect(() => {
        ...
        console.log(`AshtakavargaPage: Triggering fetch for adjusted birth time: ${formattedDateForApi}`);
        ...
        const fetchRectifiedData = async () => {
            try {
                ...
                console.log("AshtakavargaPage: Rectified data received:", response.data);
            } catch (err) {
