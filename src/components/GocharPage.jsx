...
const GocharPage = () => {
    ...
    useEffect(() => {
        ...
        console.log(`GocharPage: Triggering fetch for adjusted BIRTH time: ${formattedDateForApi}`);
        ...
        const fetchRectifiedNatalData = async () => {
            try {
                ...
                console.log("GocharPage: Rectified NATAL data received:", response.data);
            } catch (err) {
    ...
    useEffect(() => {
        ...
        console.log(`GocharPage: Triggering fetch for adjusted TRANSIT time: ${formattedDateForApi} at ${locationForGocharTool.lat}, ${locationForGocharTool.lon}`);
        ...
        const fetchTransitData = async () => {
            try {
                ...
                console.log("GocharPage: Adjusted TRANSIT data received:", response.data);
            } catch (err) {
